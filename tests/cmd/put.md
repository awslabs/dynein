...
Usage: dy put [OPTIONS] <PVAL> [SVAL]
...
Options:
  -i, --item <ITEM>      Additional attributes put into the item, which should be valid JSON. e.g. --item '{"name": "John", "age": 18, "like": ["Apple", "Banana"]}'
