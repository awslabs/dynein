...
Options:
  -s, --sort-key <SORT_KEY_EXPRESSION>  Additional Sort Key condition which will be converted to KeyConditionExpression.
  ...
  -a, --attributes <ATTRIBUTES>         Attributes to show, separated by commas, which is mapped to ProjectionExpression (e.g. --attributes name,address,age).
  ...
  -d, --descending                      Results of query are always sorted by the sort key value. By default, the sort order is ascending.
